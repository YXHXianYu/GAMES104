...
#include <bloom_composite_frag.h>
...
namespace Pilot
{
                                         ...
                                         VkImageView blur_input_attachment)
    {
        ...
        setupPipelines();
        setupDescriptorSet();
        updateAfterFramebufferRecreate(origin_input_attachment, blur_input_attachment);
    }

    void PBloomCompositePass::setupDescriptorSetLayout()
    {
    ...
    void PBloomCompositePass::setupPipelines()
    {
        ...
        VkShaderModule frag_shader_module =
            PVulkanUtil::createShaderModule(m_p_vulkan_context->_device, BLOOM_COMPOSITE_FRAG);
        ...
        pipelineInfo.subpass             = _main_camera_subpass_bloom_composite;
    ...
    void PBloomCompositePass::setupDescriptorSet()
    {
    ...
    void PBloomCompositePass::updateAfterFramebufferRecreate(VkImageView origin_input_attachment, VkImageView blur_input_attachment)
    {
        VkDescriptorImageInfo post_process_per_frame_origin_input_attachment_info = {};
        post_process_per_frame_origin_input_attachment_info.sampler =
            PVulkanUtil::getOrCreateNearestSampler(m_p_vulkan_context->_physical_device, m_p_vulkan_context->_device);
        post_process_per_frame_origin_input_attachment_info.imageView   = origin_input_attachment;
        post_process_per_frame_origin_input_attachment_info.imageLayout = VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL;

        VkDescriptorImageInfo post_process_per_frame_blur_input_attachment_info = {};
        post_process_per_frame_blur_input_attachment_info.sampler =
            PVulkanUtil::getOrCreateNearestSampler(m_p_vulkan_context->_physical_device, m_p_vulkan_context->_device);
        post_process_per_frame_blur_input_attachment_info.imageView   = blur_input_attachment;
        post_process_per_frame_blur_input_attachment_info.imageLayout = VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL;

        VkWriteDescriptorSet post_process_descriptor_writes_info[2];

        VkWriteDescriptorSet& post_process_descriptor_origin_input_attachment_write_info =
            post_process_descriptor_writes_info[0];
        post_process_descriptor_origin_input_attachment_write_info.sType           = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
        post_process_descriptor_origin_input_attachment_write_info.pNext           = NULL;
        post_process_descriptor_origin_input_attachment_write_info.dstSet          = _descriptor_infos[0].descriptor_set;
        post_process_descriptor_origin_input_attachment_write_info.dstBinding      = 0;
        post_process_descriptor_origin_input_attachment_write_info.dstArrayElement = 0;
        post_process_descriptor_origin_input_attachment_write_info.descriptorType  = VK_DESCRIPTOR_TYPE_INPUT_ATTACHMENT;
        post_process_descriptor_origin_input_attachment_write_info.descriptorCount = 1;
        post_process_descriptor_origin_input_attachment_write_info.pImageInfo = &post_process_per_frame_origin_input_attachment_info;
    
        VkWriteDescriptorSet& post_process_descriptor_blur_input_attachment_write_info =
            post_process_descriptor_writes_info[1];
        post_process_descriptor_blur_input_attachment_write_info.sType           = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
        post_process_descriptor_blur_input_attachment_write_info.pNext           = NULL;
        post_process_descriptor_blur_input_attachment_write_info.dstSet          = _descriptor_infos[0].descriptor_set;
        post_process_descriptor_blur_input_attachment_write_info.dstBinding      = 1;
        post_process_descriptor_blur_input_attachment_write_info.dstArrayElement = 0;
        post_process_descriptor_blur_input_attachment_write_info.descriptorType  = VK_DESCRIPTOR_TYPE_INPUT_ATTACHMENT;
        post_process_descriptor_blur_input_attachment_write_info.descriptorCount = 1;
        post_process_descriptor_blur_input_attachment_write_info.pImageInfo = &post_process_per_frame_blur_input_attachment_info;
    ...
    void PBloomCompositePass::draw()
    {
        if (m_render_config._enable_debug_untils_label)
        {
            VkDebugUtilsLabelEXT label_info = {
                VK_STRUCTURE_TYPE_DEBUG_UTILS_LABEL_EXT, NULL, "Bloom Map", {1.0f, 1.0f, 1.0f, 1.0f}};
