...
#include <bloom_horizontal_blur_frag.h>

namespace Pilot
{
    void PBloomHorizontalBlurPass::initialize(VkRenderPass render_pass, VkImageView input_attachment)
    {
    ...
    void PBloomHorizontalBlurPass::setupDescriptorSetLayout()
    {
    ...
    void PBloomHorizontalBlurPass::setupPipelines()
    {
        ...
        VkShaderModule frag_shader_module =
            PVulkanUtil::createShaderModule(m_p_vulkan_context->_device, BLOOM_HORIZONTAL_BLUR_FRAG);
        ...
        pipelineInfo.subpass             = _main_camera_subpass_bloom_horizontal_blur;
    ...
    void PBloomHorizontalBlurPass::setupDescriptorSet()
    {
    ...
    void PBloomHorizontalBlurPass::updateAfterFramebufferRecreate(VkImageView input_attachment)
    {
    ...
    void PBloomHorizontalBlurPass::draw()
    {
