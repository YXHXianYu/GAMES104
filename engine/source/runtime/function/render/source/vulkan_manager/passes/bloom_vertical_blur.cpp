...
#include <bloom_vertical_blur_frag.h>

namespace Pilot
{
    void PBloomVerticalBlurPass::initialize(VkRenderPass render_pass, VkImageView input_attachment)
    {
    ...
    void PBloomVerticalBlurPass::setupDescriptorSetLayout()
    {
    ...
    void PBloomVerticalBlurPass::setupPipelines()
    {
        ...
        VkShaderModule frag_shader_module =
            PVulkanUtil::createShaderModule(m_p_vulkan_context->_device, BLOOM_VERTICAL_BLUR_FRAG);
        ...
        pipelineInfo.subpass             = _main_camera_subpass_bloom_vertical_blur;
    ...
    void PBloomVerticalBlurPass::setupDescriptorSet()
    {
    ...
    void PBloomVerticalBlurPass::updateAfterFramebufferRecreate(VkImageView input_attachment)
    {
    ...
    void PBloomVerticalBlurPass::draw()
    {
