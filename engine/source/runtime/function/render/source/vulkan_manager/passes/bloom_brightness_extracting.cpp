...
#include <bloom_brightness_extracting_frag.h>

namespace Pilot
{
    void PBloomBrightnessExtractingPass::initialize(VkRenderPass render_pass, VkImageView input_attachment)
    {
    ...
    void PBloomBrightnessExtractingPass::setupDescriptorSetLayout()
    {
    ...
    void PBloomBrightnessExtractingPass::setupPipelines()
    {
        ...
        VkShaderModule frag_shader_module =
            PVulkanUtil::createShaderModule(m_p_vulkan_context->_device, BLOOM_BRIGHTNESS_EXTRACTING_FRAG);
        ...
        pipelineInfo.subpass             = _main_camera_subpass_bloom_brightness_extracting;
    ...
    void PBloomBrightnessExtractingPass::setupDescriptorSet()
    {
    ...
    void PBloomBrightnessExtractingPass::updateAfterFramebufferRecreate(VkImageView input_attachment)
    {
    ...
    void PBloomBrightnessExtractingPass::draw()
    {
